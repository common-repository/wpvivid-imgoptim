...
class WPvivid_Tab_Page_Container
{
    ...
    public function display()
    {
        ...
        <script>
            ...
            jQuery('#<?php echo esc_js($this->container_id)?>').on("click",".nav-tab-delete-img",function(event)
            {
    ...
    public function display_tabs()
    {
        ...
        foreach ($this->tabs as $tab)
        {
            ...
            if(isset($tab['can_delete']))
            {
                ...
                {
                    echo '<div class="nav-tab-delete-img" redirect="'.esc_attr($tab['redirect']).'">
